...
namespace informed_rrt_star_planner
{
  ...
  public:
    ...
    // void displayIntermediateState(ros::Publisher& intermediate_pub, informed_rrt_star_planner::BsplineOptimizer::Ptr optimizer, double sleep_time, const int start_iteration);
    // void displayNewArrow(ros::Publisher& guide_vector_pub, informed_rrt_star_planner::BsplineOptimizer::Ptr optimizer);
  };
} // namespace informed_rrt_star_planner
#endif